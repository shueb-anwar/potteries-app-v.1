...
module.exports = __webpack_require__(/*! /Users/shueb.anwar/Documents/tourlin-app/src/main.ts */"zUnb");
...
/***/ "GRJW":
/*!*******************************************!*\
  !*** ./src/app/providers/firebase/bus.ts ***!
  \*******************************************/
/*! exports provided: BusProvider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BusProvider", function() { return BusProvider; });
    ...
    getCurrentBusIndex() {
        ...
        return new Promise(function (resolve, reject) {
            ref.limitToLast(1).once("value", res => {
                console.log(res.val());
                var data = Object(lodash__WEBPACK_IMPORTED_MODULE_3__["map"])(res.val(), function (item) { return item; });
                resolve(data[0].id);
            });
        });
    }
...
BusProvider.ctorParameters = () => [
    { type: _angular_fire_database__WEBPACK_IMPORTED_MODULE_2__["AngularFireDatabase"] }
];
BusProvider = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, alertCtrl, router, auth) {
        ...
        this.alertCtrl.create({
            ...
            buttons: [
                ...
                },
                {
                    text: 'Logout',
                    handler: () => {
                        firebase_app__WEBPACK_IMPORTED_MODULE_9__["default"].auth().signOut().then(function () {
...
/***/ "VsuG":
/*!***********************************************!*\
  !*** ./src/app/providers/firebase/booking.ts ***!
  \***********************************************/
/*! exports provided: BookingProvider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*
  ...
  and Angular DI.
*/
let BookingProvider = class BookingProvider {
    constructor(db) {
        this.db = db;
    }
...
BookingProvider.ctorParameters = () => [
    { type: _angular_fire_database__WEBPACK_IMPORTED_MODULE_2__["AngularFireDatabase"] }
];
BookingProvider = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()
], BookingProvider);
...
/* harmony import */ var _providers_firebase_firebase__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./providers/firebase/firebase */ "lPxY");
/* harmony import */ var _providers_firebase_bus__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./providers/firebase/bus */ "GRJW");
/* harmony import */ var _providers_firebase_booking__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./providers/firebase/booking */ "VsuG");
/* harmony import */ var _providers_firebase_user__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./providers/firebase/user */ "yQWN");
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        providers: [
            ...
            _providers_firebase_firebase__WEBPACK_IMPORTED_MODULE_17__["FirebaseProvider"],
            _providers_firebase_bus__WEBPACK_IMPORTED_MODULE_18__["BusProvider"],
            _providers_firebase_booking__WEBPACK_IMPORTED_MODULE_19__["BookingProvider"],
            _providers_firebase_user__WEBPACK_IMPORTED_MODULE_20__["UserProvider"],
...
/***/ "lPxY":
/*!************************************************!*\
  !*** ./src/app/providers/firebase/firebase.ts ***!
  \************************************************/
/*! exports provided: FirebaseProvider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FirebaseProvider", function() { return FirebaseProvider; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _angular_fire_database__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/fire/database */ "sSZD");
...
FirebaseProvider.ctorParameters = () => [
    { type: _angular_fire_database__WEBPACK_IMPORTED_MODULE_2__["AngularFireDatabase"] }
];
FirebaseProvider = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()
], FirebaseProvider);
...
const routes = [
    ...
    {
        path: 'search-bus',
        loadChildren: './search-bus/search-bus.module#SearchBusPageModule'
    },
    {
        path: 'bus-list',
        loadChildren: './bus-list/bus-list.module#BusListPageModule'
    },
    {
        path: 'user-profile',
...
/***/ "yQWN":
/*!********************************************!*\
  !*** ./src/app/providers/firebase/user.ts ***!
  \********************************************/
